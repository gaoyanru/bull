angular.module('channelApp').controller('ReviewCusCtrl', ['$scope', '$http', '$filter', '$uibModal','PyCapital', function($scope, $http, $filter, $uibModal,PyCapital) {
    'use strict';
    $scope.title = "注册审核";
    var tbOptions = [{
        header: '省',
    ...
    $scope.audit = function(order) {
        $http.put('/api/orderszj/audit/' + order.OrderId).success(function(result) {
    ...
    function refreshData(data) {
        ...
        $http.get('/api/orderszj/agent?' + jQuery.param(data)).success(function(result) {
